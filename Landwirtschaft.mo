...
cW-Wert: %cW")}),
    ...
    model Chassis_Anhaenger
      //Parameter
      parameter Modelica.Units.SI.Mass m = 500 "Gewicht Anhaenger";
      parameter Real cW = 0.1 "Luftwiederstandsbeiwert";
      parameter Modelica.Units.SI.Area A = 0.1 "Fläche Anhaenger vorne";
      constant Modelica.Units.SI.Density rho = 1.204 "Dichte von Luft bei 20°C und 1,013 bar";
      //Variablen
      Modelica.Units.SI.Acceleration a "Translatorische Beschleunigung in horizontale";
      Modelica.Units.SI.Velocity v "Translatorische Geschwindigkeit in horizontale";
      ...
      Landwirtschaft.Connectoren.Translatoric translatoric annotation(
        Placement(visible = true, transformation(origin = {40, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {52, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Landwirtschaft.Connectoren.Translatoric Kupplungsaufnahme annotation(
        Placement(visible = true, transformation(origin = {-74, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      F_air = 0.5 * cW * A * rho * v ^ 2;
      m * a = translatoric.F - F_air;
      der(v) = a;
      der(translatoric.s) = v;
      annotation(
        Icon(coordinateSystem(extent = {{-100, -50}, {80, 50}}), graphics = {Rectangle(origin = {-10, 0}, fillColor = {195, 195, 195}, fillPattern = FillPattern.Solid, extent = {{-90, 50}, {90, -50}}), Text(origin = {-70, -24}, rotation = 180, extent = {{-30, 18}, {30, -18}}, textString = "Kupplungs-
   aufnahme"), Text(origin = {49, -34}, extent = {{-27, 8}, {27, -8}}, textString = "Radlager"), Text(origin = {-48, 24}, extent = {{-50, 24}, {50, -24}}, textString = "Masse: %m
    Fläche Front: %A
    cW-Wert: %cW")}),
        Diagram(coordinateSystem(extent = {{-100, -50}, {80, 50}})));
    end Chassis_Anhaenger;
    ...
    model Rad_Anhaenger
      ...
      //Schnittstellen
      Modelica.Blocks.Interfaces.RealOutput vehicle_vel annotation(
        Placement(visible = true, transformation(origin = {-40, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-102, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    equation
      vehicle_vel = der(translatoric.s);
      J * der(omega) = translatoric.F * r;
      annotation(
        Icon(graphics = {Text(origin = {-43, 60}, extent = {{-57, 12}, {57, -12}}, textString = "Radlager"), Text(origin = {-27, -56}, extent = {{-59, 10}, {59, -10}}, textString = "v_Measurment"), Rectangle(extent = {{-100, 100}, {100, -100}}), Ellipse(origin = {70, 70}, fillPattern = FillPattern.Solid, extent = {{-30, 30}, {30, -30}}), Ellipse(origin = {70, 70}, fillColor = {211, 211, 211}, fillPattern = FillPattern.Solid, extent = {{-22, 22}, {22, -22}}), Ellipse(origin = {70, 70}, fillPattern = FillPattern.Solid, extent = {{-4, 4}, {4, -4}})}));
    end Rad_Anhaenger;
  end Hilfsmodelle;
  ...
  package Arbeitsgeraete
    model Masse
      ...
      // Parameter
      parameter Modelica.Units.SI.Mass m = 200 "Masse in kg";
  ...
  package Zugmaschinen
    ...
    equation
      ...
      connect(rad.translatoric, chassis.translatoric) annotation(
        Line(points = {{104, 59.2}, {183, 59.2}, {183, 169}}));
